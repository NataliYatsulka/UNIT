...
// #define	STRANGE		//aka undefined tests       //well done
...
//Strange undefined tests to test the atoi of the field width and presicion
	...
	printf("\nRound 4:|ll.15.12|\t|.ll 15.12|\t\t|.015ll.12|\t|.ll#15.12|\t\t|.ll#15.12d|\n");
	PRINTF("|%ll.15.12d|\t|%.ll 15.12d|\t|%.015ll.12d|\t|%.ll#15.12d|\t|%.ll#15.12d|",-42,-42,-42,-42,-42);
#endif
